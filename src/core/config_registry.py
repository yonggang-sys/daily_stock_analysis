...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "ZHIPU_API_KEYS": {
        "title": 'Zhipu (GLM) API Keys',
        "description": 'GLM / 智谱 API keys for the second fallback tier. Comma-separated for rotation.',
        "category": "ai_model",
        "data_type": 'string',
        "ui_control": 'password',
        "is_sensitive": True,
        ...
        "validation": {},
        "display_order": 20,
        "help_key": "settings.ai_model.ZHIPU_API_KEYS",
        "examples": [
            'ZHIPU_API_KEYS=xxxx.yyyy,aaaa.bbbb',
            'ZHIPU_API_KEY=xxxx.yyyy',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "OPENROUTER_API_KEYS": {
        ...
        "description": 'OpenRouter API keys for the last-resort fallback tier. Comma-separated for rotation.',
        "category": "ai_model",
        "data_type": 'string',
        "ui_control": 'password',
        "is_sensitive": True,
        ...
        "validation": {},
        "display_order": 21,
        "help_key": "settings.ai_model.OPENROUTER_API_KEYS",
        "examples": [
    ...
    "LLM_ZHIPU_MODELS": {
        "title": 'GLM Models',
        "description": 'Comma-separated GLM model list for the second fallback tier, in try order.',
        "category": "ai_model",
        "data_type": 'string',
        "ui_control": 'text',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 22,
        "help_key": "settings.ai_model.LLM_ZHIPU_MODELS",
        "examples": [
            'LLM_ZHIPU_MODELS=zhipuai/glm-4.6',
            'ZHIPU_MODEL=zhipuai/glm-4-plus',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_OPENROUTER_MODELS": {
        ...
        "description": 'Comma-separated OpenRouter model list for the last-resort tier, in try order.',
        "category": "ai_model",
        "data_type": 'string',
        "ui_control": 'text',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 23,
        "help_key": "settings.ai_model.LLM_OPENROUTER_MODELS",
        "examples": [
            'LLM_OPENROUTER_MODELS=openrouter/deepseek/deepseek-chat',
    ...
    "LLM_FALLBACK_CHAIN_ENABLED": {
        "title": 'Fallback Chain',
        "description": 'Master switch for error-class-aware provider fallback. When disabled, any failure moves to the next model immediately (legacy behaviour).',
        "category": "ai_model",
        "data_type": 'boolean',
        "ui_control": 'switch',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 24,
        "help_key": "settings.ai_model.LLM_FALLBACK_CHAIN_ENABLED",
        "examples": [
            'LLM_FALLBACK_CHAIN_ENABLED=true',
            'LLM_FALLBACK_CHAIN_ENABLED=false',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_FALLBACK_MAX_IN_PLACE_RETRIES": {
        "title": 'In-place Retries',
        "description": 'How many times a transient failure (503/timeout/bare 429) is retried against the same provider before downgrading.',
        "category": "ai_model",
        "data_type": 'integer',
        "ui_control": 'number',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 25,
        "help_key": "settings.ai_model.LLM_FALLBACK_MAX_IN_PLACE_RETRIES",
        "examples": [
            'LLM_FALLBACK_MAX_IN_PLACE_RETRIES=2',
            'LLM_FALLBACK_MAX_IN_PLACE_RETRIES=0',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_FALLBACK_BACKOFF_BASE_SECONDS": {
        ...
        "description": 'Base seconds for the exponential backoff used by in-place provider retries (attempt 1 = base, attempt 2 = 2x base).',
        "category": "ai_model",
        "data_type": 'number',
        "ui_control": 'number',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 26,
        "help_key": "settings.ai_model.LLM_FALLBACK_BACKOFF_BASE_SECONDS",
        "examples": [
            'LLM_FALLBACK_BACKOFF_BASE_SECONDS=1',
            'LLM_FALLBACK_BACKOFF_BASE_SECONDS=2.5',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_FALLBACK_BACKOFF_MAX_SECONDS": {
        "title": 'Retry Backoff Cap',
        "description": 'Upper bound, in seconds, for a single in-place retry wait.',
        "category": "ai_model",
        "data_type": 'number',
        "ui_control": 'number',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 27,
        "help_key": "settings.ai_model.LLM_FALLBACK_BACKOFF_MAX_SECONDS",
        "examples": [
            'LLM_FALLBACK_BACKOFF_MAX_SECONDS=30',
            'LLM_FALLBACK_BACKOFF_MAX_SECONDS=15',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_JSON_OUTPUT_MODE": {
        ...
        "description": 'Force provider-native JSON output. auto attaches JSON parameters only when a JSON validator is in use; on always attaches; off disables.',
        "category": "ai_model",
        "data_type": 'string',
        "ui_control": 'select',
        "is_sensitive": False,
        ...
        "validation": {"enum": ['auto', 'on', 'off']},
        "display_order": 28,
        "help_key": "settings.ai_model.LLM_JSON_OUTPUT_MODE",
        "examples": [
            'LLM_JSON_OUTPUT_MODE=auto',
            'LLM_JSON_OUTPUT_MODE=on',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "OPENROUTER_QUOTA_GUARD_ENABLED": {
        "title": 'OpenRouter Quota Guard',
        "description": 'Gate OpenRouter behind the quota ledger so its scarce daily allowance is only spent after the earlier tiers fail.',
        "category": "ai_model",
        "data_type": 'boolean',
        "ui_control": 'switch',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 29,
        "help_key": "settings.ai_model.OPENROUTER_QUOTA_GUARD_ENABLED",
        "examples": [
            'OPENROUTER_QUOTA_GUARD_ENABLED=true',
            'OPENROUTER_QUOTA_GUARD_ENABLED=false',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "OPENROUTER_QUOTA_DAILY_LIMIT": {
        "title": 'OpenRouter Daily Limit',
        "description": 'Daily OpenRouter call budget used by the quota ledger.',
        "category": "ai_model",
        "data_type": 'integer',
        "ui_control": 'number',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 30,
        "help_key": "settings.ai_model.OPENROUTER_QUOTA_DAILY_LIMIT",
        "examples": [
            'OPENROUTER_QUOTA_DAILY_LIMIT=50',
            'OPENROUTER_QUOTA_DAILY_LIMIT=1000',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "OPENROUTER_QUOTA_RESERVE_AFTER": {
        "title": 'OpenRouter Reserve Threshold',
        "description": 'Once the ledger reaches this count, OpenRouter is only used for quota-exhausted downstream failures, keeping the rest as emergency reserve.',
        "category": "ai_model",
        "data_type": 'integer',
        "ui_control": 'number',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 31,
        "help_key": "settings.ai_model.OPENROUTER_QUOTA_RESERVE_AFTER",
        "examples": [
            'OPENROUTER_QUOTA_RESERVE_AFTER=45',
            'OPENROUTER_QUOTA_RESERVE_AFTER=40',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_PROVIDER_RATE_LIMIT_ENABLED": {
        "title": 'Provider Rate Limit',
        "description": 'Enable per-provider token-bucket rate limiting (RPM) to avoid triggering quota errors in the first place.',
        "category": "ai_model",
        "data_type": 'boolean',
        "ui_control": 'switch',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 32,
        "help_key": "settings.ai_model.LLM_PROVIDER_RATE_LIMIT_ENABLED",
        "examples": [
            'LLM_PROVIDER_RATE_LIMIT_ENABLED=true',
            'LLM_PROVIDER_RATE_LIMIT_ENABLED=false',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_PROVIDER_RPM_GEMINI": {
        "title": 'Gemini RPM',
        "description": 'Requests per minute allowed for the Gemini tier. Halved automatically in GitHub Actions when LLM_PROVIDER_RPM_GHA_HALVE is enabled.',
        "category": "ai_model",
        "data_type": 'integer',
        "ui_control": 'number',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 33,
        "help_key": "settings.ai_model.LLM_PROVIDER_RPM_GEMINI",
        "examples": [
            'LLM_PROVIDER_RPM_GEMINI=10',
            'LLM_PROVIDER_RPM_GEMINI=5',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_PROVIDER_RPM_ZHIPU": {
        "title": 'GLM RPM',
        "description": 'Requests per minute allowed for the GLM / Zhipu tier.',
        "category": "ai_model",
        "data_type": 'integer',
        "ui_control": 'number',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 34,
        "help_key": "settings.ai_model.LLM_PROVIDER_RPM_ZHIPU",
        "examples": [
            'LLM_PROVIDER_RPM_ZHIPU=60',
            'LLM_PROVIDER_RPM_ZHIPU=30',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_PROVIDER_RPM_OPENROUTER": {
        "title": 'OpenRouter RPM',
        "description": 'Requests per minute allowed for the OpenRouter tier. Kept low on purpose to protect the daily allowance.',
        "category": "ai_model",
        "data_type": 'integer',
        "ui_control": 'number',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 35,
        "help_key": "settings.ai_model.LLM_PROVIDER_RPM_OPENROUTER",
        "examples": [
            'LLM_PROVIDER_RPM_OPENROUTER=5',
            'LLM_PROVIDER_RPM_OPENROUTER=2',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_CACHE_ENABLED": {
        ...
        "description": 'Reuse recent LLM analysis results from the local SQLite cache instead of paying for a duplicate call.',
        "category": "ai_model",
        "data_type": 'boolean',
        "ui_control": 'switch',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 36,
        "help_key": "settings.ai_model.LLM_CACHE_ENABLED",
        "examples": [
    ...
    "LLM_CACHE_TTL_SECONDS": {
        "title": 'LLM Cache TTL',
        "description": 'Time-to-live in seconds for cached LLM analysis results. Default 86400 (24 hours).',
        "category": "ai_model",
        "data_type": 'integer',
        "ui_control": 'number',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 37,
        "help_key": "settings.ai_model.LLM_CACHE_TTL_SECONDS",
        "examples": [
            'LLM_CACHE_TTL_SECONDS=86400',
            'LLM_CACHE_TTL_SECONDS=43200',
        ],
        "docs": [
            {
                "label": 'LLM 配置指南',
    ...
    "LLM_PROVIDER_PRECHECK_ENABLED": {
        "title": 'Provider Precheck',
        "description": 'Ping each configured provider once per run to detect unusable credentials before analysing every stock.',
        "category": "ai_model",
        "data_type": 'boolean',
        "ui_control": 'switch',
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 38,
        "help_key": "settings.ai_model.LLM_PROVIDER_PRECHECK_ENABLED",
        "examples": [
            'LLM_PROVIDER_PRECHECK_ENABLED=true',
